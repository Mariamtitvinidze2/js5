...
console.log((function(a, b) { return a - b; })(8, 3)); 
...
console.log((function(n) { return n * 2; })(5));
...
// 14. Callback Function და რიცხვის დამატება
function addNumbers(a, b, callback) {
  return callback(a + b);
}
addNumbers(12, 13, (result) => console.log(result)); 

// 15. Arrow Function, რომელიც რიცხვის კვადრატს დააბრუნებს
